...
//=======================================================================
// USDJPY 24/5 TUNING NOTES (on top of original v2 "Including new Trailing Stops")
...
// - MaxSpread and Slippage defaults recalibrated for USD/JPY's typical
//   tight ECN spread instead of the original placeholder (5555 effectively
//   disabled the spread filter entirely). Re-check these against your
//   own broker's live Market Watch spread before trusting them.
...
input group "TRADE SETTING IN POINTS"; // TRADE SETTINGS
      ...
      input int MaxSpread = 18; // Max Spread Limit in points (~1.8 pips starting ceiling for USDJPY; verify against your broker's live spread and tighten)
